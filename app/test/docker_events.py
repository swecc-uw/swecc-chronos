from app.models.container import convert_raw_event_to_docker_event, convert_docker_event_to_dynamo
...
for event in DOCKER_EVENT_MOCK_DATA:
    ...
    dynamo_event = convert_docker_event_to_dynamo(docker_event)
    print(dynamo_event)
